...
const TabsList = React.forwardRef(({ className, ...props }, ref) => <TabsPrimitive.List ref={ref} className={cn("inline-flex h-auto rounded-md p-1 text-black", className)} {...props} />);
